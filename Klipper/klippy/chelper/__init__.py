...
SOURCE_FILES = [
    ...
    'kin_extruder.c', 'kin_shaper.c', 'kin_idex.c', 'kin_crossed_hbot.c',
]
...
defs_kin_crossed_hbot = """
    struct stepper_kinematics *crossed_hbot_stepper_alloc(char type);
"""
...
defs_all = [
    ...
    defs_kin_extruder, defs_kin_shaper, defs_kin_idex, defs_kin_crossed_hbot,
]
